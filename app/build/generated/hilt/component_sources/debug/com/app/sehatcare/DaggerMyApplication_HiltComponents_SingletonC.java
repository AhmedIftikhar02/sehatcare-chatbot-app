...
import com.app.sehatcare.chat.presentation.ui.ChatFragment;
...
import com.app.sehatcare.common.managers.SharedPrefsManager;
...
import com.app.sehatcare.di.NetworkModule_ProvideChatApiServiceFactory;
import com.app.sehatcare.di.NetworkModule_ProvideMoshiFactory;
import com.app.sehatcare.di.NetworkModule_ProvideOkHttpClientFactory;
import com.app.sehatcare.di.NetworkModule_ProvideRetrofitFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_app_sehatcare_chat_presentation_viewmodel_ChatViewModel, ChatViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_app_sehatcare_chat_presentation_viewmodel_ChatViewModel = "com.app.sehatcare.chat.presentation.viewmodel.ChatViewModel";

      @KeepFieldType
      ChatViewModel com_app_sehatcare_chat_presentation_viewmodel_ChatViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_app_sehatcare_chat_presentation_viewmodel_ChatViewModel, ((Provider) chatViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.app.sehatcare.chat.presentation.viewmodel.ChatViewModel 
          return (T) new ChatViewModel(singletonCImpl.bindChatRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.chatRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 3);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.app.sehatcare.common.managers.ThemeManager 
          return (T) new ThemeManager(singletonCImpl.sharedPrefsManagerProvider.get());

          case 1: // com.app.sehatcare.common.managers.SharedPrefsManager 
          ...
          case 2: // com.app.sehatcare.common.bus.LoginEventBus 
          return (T) new LoginEventBus();

          case 3: // com.app.sehatcare.chat.data.repository.ChatRepositoryImpl 
          return (T) new ChatRepositoryImpl(singletonCImpl.provideChatApiServiceProvider.get(), singletonCImpl.networkMonitorProvider.get());

          case 4: // com.app.sehatcare.chat.data.remote.ChatApiService 
          ...
          case 7: // com.app.sehatcare.core.session.SessionManager 
          ...
          case 9: // com.app.sehatcare.core.network.NetworkMonitor 
